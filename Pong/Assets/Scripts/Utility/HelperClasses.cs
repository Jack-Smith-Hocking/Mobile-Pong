...
namespace Custom.Utility
{
    ...
    {
        [SerializeField] private float m_maxVal = 0;
        [SerializeField] private float m_minVal = 0;

        public float MaxVal
        {
            get
            {
                return (m_maxVal > m_minVal) ? m_maxVal : m_minVal;
            }
        }
        public float MinVal
        {
            get
            {
                return (m_minVal < m_maxVal) ? m_minVal : m_maxVal;
            }
        }
    ...
    public static class GeneralUtil
    {
        ...
        /// <returns></returns>
        public static IEnumerator DelayedActionEOF(System.Action action)
        {
            if (action == null) yield return null;
